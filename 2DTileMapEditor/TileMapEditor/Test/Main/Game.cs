...
namespace TileMapEditor.Test.Main
{
    public abstract class Game
    {
        ...
        protected const int MAX_TARGET_FPS = 10000;
        protected const int MIN_TARGET_FPS = 10;
        ...
        {
            Gsm.Render(g);
            g.DrawString("UpdateFPS:" + Window.UpdateFps, Window.Font, Brushes.White, 5, 5);
            g.DrawString("RenderFPS:" + Window.RenderFps, Window.Font, Brushes.White, 5, 20);
        }
